...
public final class EdicionRepository {
  ...
  public static EdicionRepository get() {
    return INSTANCE;
  }
  ...
  public TipoRegistro obtenerTipoRegistro(EntityManager em, String nombre) {
    // Stub: in real integration would search for TipoRegistro by name in specific
    // edition
    return em.createQuery(
   ...
   */
  public datatypes.DTEdicionDetallada obtenerDatosDetalladosEdicion(EntityManager em, String nombreEvento,
  ...
  public boolean existeNombre(EntityManager em, String nombre) {
    return em.createQuery("select count(e) from Edicion e where e.nombre = :n", Long.class)

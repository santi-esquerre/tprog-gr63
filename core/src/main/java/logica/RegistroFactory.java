...
public final class RegistroFactory {
  ...
  public void altaRegistro(EntityManager em, Edicion ed, Asistente as, TipoRegistro tr, float costo){
    var r = new Registro();
    // Seteo por reflexión para mantener entidades sin setters públicos
    try {
      var f1 = Registro.class.getDeclaredField("fecha"); f1.setAccessible(true); f1.set(r, new Date());
